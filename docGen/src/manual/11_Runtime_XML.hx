...
You can use all <a href="#manual/04_Advanced_XML.html">advanced xml features</a> except event handlers.
...
So it's completely type-unsafe and slow comparing to standart (and recommended) compile time xml processing.
