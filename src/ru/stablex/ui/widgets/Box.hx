    ...
    */
        ...
        */
        @:noCompletion static private inline function _objWidth (obj:DisplayObject) : Float {
            // #if html5
                ...
                }else if( Std.is(obj, ru.stablex.backend.text.TextField) ){
                    return cast(obj, ru.stablex.backend.text.TextField).textWidth + 4;
                }else{
                    return obj.width;
                }
            // #else
        ...
        @:noCompletion static private inline function _objHeight (obj:DisplayObject) : Float {
            // #if html5
                if( Std.is(obj, Widget) ){
                    ...
                    return cast(obj, ru.stablex.backend.text.TextField).textHeight + 4;
                }else{
                    return obj.height;
                }
            // #else
        ...
        */
        @:noCompletion static private inline function _setObjX (obj:DisplayObject, x:Float) : Void {
            #if html5
                obj.x = (Std.is(obj, ru.stablex.backend.text.TextField) ? obj.x = x + 2 : x);
            #else
                obj.x = x;
            #end
        }//function _setObjX()
        ...
        */
        @:noCompletion static private inline function _setObjY (obj:DisplayObject, y:Float) : Void {
            #if html5
                obj.y = (Std.is(obj, ru.stablex.backend.text.TextField) ? obj.y = y + 2 : y);
            #else
                obj.y = y;
            #end
        }//function _setObjY()
    ...
    @:noCompletion private function _vAlignBottom () : Void {
        ...
        if( this.vertical ){
            ...
            for(i in 0...this.numChildren){
                ...
                lastY   = child.y - this.childPadding #if html5 - (Std.is(child, ru.stablex.backend.text.TextField) ? 2 : 0) #end;
            }
    ...
    @:noCompletion private function _hAlignRight () : Void {
        ...
        //horizontal box
            ...
            for(i in 0...this.numChildren){
                ...
                lastX = child.x #if html5 - (Std.is(child, ru.stablex.backend.text.TextField) ? 2 : 0) #end - this.childPadding;
            }
        }
