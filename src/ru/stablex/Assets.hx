...
class Assets{
    ...
    *
    */
    static dynamic public function getBitmapData(src:String, useCache:Bool = true) : ru.stablex.backend.display.BitmapData {
    ...
    *
    */
    static dynamic public function getBytes(src:String) : ru.stablex.backend.utils.ByteArray {
    ...
    *
    */
    static public inline function getFont(src:String) : ru.stablex.backend.text.Font {
    ...
    *
    */
    static dynamic public function getSound(src:String) : ru.stablex.backend.media.Sound {
